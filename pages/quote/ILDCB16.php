...
function getVal($val) {
    ...
    $path="https://api.gto.co.il:9005/v2/xml/market/table/simple?securities=6120166&fields=".$val;
...
<html>
<head>
        <link href="css/quote.css" rel="stylesheet" type="text/css" media="all">
</head>
<body>
...
<div>
    <dl>
        ...
        <dt>שם:</dt>
        <dd><?php echo "&nbsp;"; print_r($HebName); ?></dd>
        <dt>שער:</dt>
